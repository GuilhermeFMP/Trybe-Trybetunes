...
Quarto projeto de Front-End fornecido pela instituição Trybe, onde criamos um website que possui uma lista de musicas e podemos salvar as favoritas e pesquisar aquelas que procuramos.


## Aprendizados

Aprendi sobre os os ciclos de vida do React, além React Router.
...
```bash
  git@github.com:GuilhermeFMP/Trybe-Trybetunes.git
  cd Trybe-Trybetunes
  npm install
```
